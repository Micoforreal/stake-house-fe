...
const navLinks = [
    ...
    { name: "News", path: "/news-feeds", icon: <Newspaper className="max-w-10 w-[70%]" /> },
    { name: "Earn", path: "/earn", icon: <CircleDollarSign className="max-w-10 w-[70%]" /> },
    { name: "Ranking", path: "/rankings", icon: <BarChart className="max-w-10 w-[70%] " /> },
]
...
const HomeHeader = () => {
    return (
        <>
            ...
            <div className="w-screen px-3 md:hidden  max-w-[550px] fixed z-50 bottom-0 bg-white border-t-2">
